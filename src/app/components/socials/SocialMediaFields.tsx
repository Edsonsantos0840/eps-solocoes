...
export const  SocialMediaFields: SocialMediaProps[] = [
    {
        ...
        ico: <FaGithubSquare className="w-[5rem] h-[5rem] lg:w-[4rem] lg:h-[4rem]" />
    },
    {
        href: "https://www.linkedin.com/in/edsonpsantos/"  ,
        aria: "Perfil no LinkedIn de Edson Santos",
        ico: <FaLinkedin className="w-[5rem] h-[5rem] lg:w-[4rem] lg:h-[4rem]" />
    },
    {
        ...
        ico: <FaWhatsapp className="w-[5rem] h-[5rem] lg:w-[4rem] lg:h-[4rem]" />
    },
    {
        href: "mailto:edsonpsantos@gmail.com" ,
        aria: "Enviar email para Edson Santos",
        ico: <TfiEmail className="w-[5rem] h-[5rem] lg:w-[4rem] lg:h-[4rem]" />
    },
